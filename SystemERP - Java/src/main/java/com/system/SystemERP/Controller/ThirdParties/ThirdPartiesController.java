...
public class ThirdPartiesController {
    ...
    public ResponseEntity<ThirdParties> createThirdParty(@RequestBody ThirdPartiesDTO thirdPartiesDTO) {
    ...
    public ResponseEntity<ThirdParties> findById(@PathVariable Integer idTerceiros) {
    ...
    public ResponseEntity<List<ThirdParties>> findAll() {
